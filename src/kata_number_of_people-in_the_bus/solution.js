 ...
 * bus stop. You are provided with a list (or array) of integer arrays
 ...
 * (The second item) in a bus stop. Your task is to return number of people who
 * are still in the bus after the last bus station (after the last array). Even
 * though it is the last bus stop, the bus is not empty and some people are
